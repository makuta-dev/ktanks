...
* [x] **Shader Wrapper:** Create a C++ class to compile and manage Vertex/Fragment shaders.
...
* [ ] **Sprite Renderer:** Build a generic system to draw textures with rotation and scaling.
