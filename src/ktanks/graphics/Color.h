...
namespace ktanks {
    ...
    public:
        ...
        explicit constexpr Color(const glm::vec4& v);
        explicit constexpr Color(const glm::vec3& v, float alpha = 1.0f);
        constexpr Color(uint8_t r8, uint8_t g8,uint8_t b8, uint8_t a8 = 255);
